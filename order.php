  ...
  <div class="container-fluid">
	...
	<?php
        ...
        <tr align="center">
        	...
        	<td><?php if($rs["status"] == "y")
                        {
                                echo "<img src=\"pics/y.png\" width=10 height=10>";
                        } else {
                                echo "<img src=\"pics/n.png\" width=10 height=10>";
                        }?></td>
        	<td><a href="detailorder.php?id=<?phpecho $rs["order_id"];?>">รายละเอียด</a></td>
        	<td><a href="deleteorder.php?id=<?phpecho $rs["order_id"];?>">ลบ</a></td>
                <?php
                if ($rs["status"] == "n") {
                ?>
                <td>
                 <a href="ordercheck.php?id=<?phpecho $rs["order_id"];?>" ><input type="submit" value="ส่งสินค้า" >
               </a></td>
                <?php
                }
                ?>
