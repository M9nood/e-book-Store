...
<nav class="navbar navbar-default">
  <div class="container-fluid">
	...
	<?php
        ...
        <form enctype="multipart/form-data" action="editbook2.php" method="post">
        <div class="form-group">
        <table bgcolor="dddfff" style="padding-top:30px;">
                <tr>
                <td>ชื่อหนังสือ</td>
                <td><input type="text" value="<?php echo $rs["Book_name"];?>" size="70" name="bookname"></td>
                </tr>
                ...
                <tr>
                <td>ชื่อผู้แต่ง</td>
                <td><input type="text" value="<?php echo $rs["author"];?>" size="70" name="author"></td>
                </tr>
                <tr>
                <td>ราคา</td>
                <td><input type="text" value="<?php echo $rs["Book_cost"];?>" size="10" name="cost"></td>
                </tr>

                <tr>
                <td>จำนวน</td>
                <td><input type="text" value="<?php echo $rs["Book_num"];?>" size="5" name="num"></td>
                </tr>
                <tr>
                <td>รูปภาพ</td>
                <td>
                <img width=100 height=140 src="pics/book/<?php echo $rs["picture"];?>">
