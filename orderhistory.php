...
<div class="single-product-area">
        ...
        <div class="container">
            <div class="row">
               ...
               <center> <h1>ประวัติการสั่งซื้อ </h1> </center>
              <!-- //////////////////////////////////    แสดง order    -->
               <div class="col-md-8">
                <table class="table table-striped table-hover ">
                  ...
                  ?>
                    <tr>
                      <td><a href=<?php echo " 'list_order.php?idorder=".$rs[0]."'";?>><?php echo $rs["order_id"];?></a></td>
                      <td><?php echo $rs["order_date"];?></td>
                      <td><?php if ($rs["status"] == "y") {
                        echo "<img src=\"pics/y.png\" height=10 width=10>";
                      } else {
                        echo "<img src=\"pics/n.png\" height=10 width=10>";
                      }
                      ?></td>
                    </tr>
                    <?php
