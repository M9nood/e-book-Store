...
<link rel="shortcut icon" type="image/x-icon" href="pics/icon.ico">
  ...
  <?php
    ...
    $sql ="select  view from book where Book_id='".$Book_id."'";
    $result = mysql_query($sql,$conn);
       while($rs = mysql_fetch_array($result)){
            $view = $rs['view']+1;
       }
       mysql_query("update book set view=".$view." where Book_id='".$Book_id."'",$conn);
  ...
  <body>
    ...
    <div class="mainmenu-area">
      ...
      $result = mysql_query($sql2,$conn);
       ...
       ?>
                        ...
                        <li class="active"><a href="">ข้อมูลหนังสือ</a></li>
    ...
    <div class="single-product-area">
        ...
        <?php
     $sql = "select * from book b join booktype t on b.type_id = t.type_id where Book_id='" .$Book_id."' ";
                 ...
                 <div class="col-md-8">
                    <div class="product-content-right">
                        <div class="product-breadcroumb">
                            ...
                            <a href=shop.php?type=<?php  echo $rs['type_id'];?>><?php echo $rs['type_name']; ?></a>
                            <a href="single-product.php?id=<?php echo $rs["Book_id"];?>" ><?php echo $Book_name; ?></a>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="product-images">
                                    <div class="product-main-img">
                                        <?php echo '<img src="pics/book/'.$rs["picture"] .'"   />' ; ?>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    <h2 class="product-name"><?php echo $Book_name;?></h2>
                                    <div class="product-inner-price">
                                        <ins><?php echo $rs["Book_cost"];?>.00</ins>&nbsp &nbspบาท
                                    </div>
                                    ...
                                    <form action="cart.php" class="cart" method="get">
                                        ...
                                        <button class="add_to_cart_button" type="submit">หยิบใส่ตะกร้า</button>
                                    </form>
                                    ...
                                    <div role="tabpanel">
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade in active" id="home">
                                                ...
                                                <p>ผู้เขียน : &nbsp<?php echo $rs["author"]?><br>
                                                      หมวดหมู่ : &nbsp <?php echo $rs['type_name']; ?> <br>
                                                </p>
                                            </div>
